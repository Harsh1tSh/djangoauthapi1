...
from account.serializers import UserChangePasswordSerializer,SendPasswordResetEmailSerializer, UserPasswordResetSerializer
...
class UserRegistrationView(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            return Response({'token':token,'msg':'Registration Sucessfull'},
